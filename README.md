...
- 🎯 Entry points to execute your program using `python -m <paper_trading>` or `$ paper_trading` with basic CLI argument parsing.
...
Awesome paper_trading created by saltisgood
...
```py
from paper_trading import BaseClass
from paper_trading import base_function
